...
const tiers = [
  {
    ...
    description: "Access to foundational Module A of current program theme.",
    features: [
    ...
    yearlyFeatures: [
      ...
      "All 4 transformational programs",
      "All downloadable worksheets",
  ...
  },
  {
    ...
    description: "Enhanced access with advanced modules and additional hubs.",
    features: [
      "Modules A & B access",
      "All Basic membership benefits",
      "Access to additional Resilient Hubs",
      "Priority support",
    ],
    yearlyFeatures: [
      "All modules (A, B, C) across all programs",
      "4 hrs personal consultations (€348 value)",
      "Art expressive therapy materials kit",
      "Additional Hub: Navigating Health Challenges",
    ],
    cta: "Go Premium",
    featured: true,
  },
